...
namespace ZE.MechBattle.Navigation
{
    ...
    {
        [ReadOnly] public NativeList<IntTriangularPos> ZeroCells;
        ...
        public void Execute()
        {
            ...
            _exitFlowDirectionPeak = TriangularMath.GetHexEdgeExitVector(ExitDirection, true);
            _exitFlowDirectionValley = TriangularMath.GetHexEdgeExitVector(ExitDirection, false);
        ...
        void SetupExitCells()
        {
            var exitDirectionPeak = (int)ExitDirection.ToNeighbourDirectionFromPeak();
            var exitDirectionValley = (int)ExitDirection.ToNeighbourDirectionFromValley();

            foreach (var pos in ZeroCells)
            {
