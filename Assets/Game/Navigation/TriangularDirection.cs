...
namespace ZE.MechBattle.Navigation
{
    ...
    public static class NeighbourDirectionExtension
    {
        ...
        [BurstCompile]
        public static int3 ToTriangularOffsetVector(this PeakNeighbour peakNeighbour) => PeakNeighbourOffsets.GetOffset(peakNeighbour);

        [BurstCompile]
        public static int3 ToTriangularOffsetVector(this ValleyNeighbour valleyNeighbour) => ValleyNeighbourOffsets.GetOffset(valleyNeighbour);
