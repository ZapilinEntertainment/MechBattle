...
namespace ZE.MechBattle
{
    public static class LayerConstants
    {
        ...
        public static readonly int FirelineCastMask = LayerMask.GetMask(DEFAULT_LAYER_NAME, GROUND_LAYER_NAME, NavigationConstants.OBSTACLE_LAYER_NAME);
        public static readonly int RayWeaponCastMask = ProjectilesCastMask;
