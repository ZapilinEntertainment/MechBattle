...
{
    public interface IProcessLaunchData { }

    public abstract class ProcessManagerBase<ProcessInput,ProcessOutput, Process, ProcessLaunchData, Token> : IDisposable 
        where Process: IProcess<ProcessInput, ProcessOutput> 
        where ProcessLaunchData : IProcessLaunchData
